...
public class WebRTCVad
{
        ...
        throws UnsupportedSampleRateException
    {
        if(!isValidSampleRate(sampleRate))
        {
            throw new UnsupportedSampleRateException(sampleRate,
                                             org.jitsi.webrtcvadwrapper.WebRTCVad.VALID_SAMPLE_RATES);
        }
        ...
        throws UnsupportedSampleRateException, UnsupportedVadModeException
    {
        ...
        if(!isValidVadMode(mode))
        {
            throw new UnsupportedVadModeException(mode,
                                              org.jitsi.webrtcvadwrapper.WebRTCVad.VALID_VAD_MODES);
        }
    ...
    /**
     * @see org.jitsi.webrtcvadwrapper.WebRTCVad#isSpeech(int[])
     */
     ...
     * {@link org.jitsi.webrtcvadwrapper.WebRTCVad} can accept.
     *
     ...
     * array this {@link org.jitsi.webrtcvadwrapper.WebRTCVad} can accept.
     *

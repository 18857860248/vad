    ...
    implements AudioSegment
{
     ...
     * {@link org.jitsi.webrtcvadwrapper.audio.ByteSignedPcmAudioSegment} into a single instance.
     * @param segments the list of {@link org.jitsi.webrtcvadwrapper.audio.ByteSignedPcmAudioSegment}
     * @return every segment of the list merged into a single segment
     */
    public static org.jitsi.webrtcvadwrapper.audio.ByteSignedPcmAudioSegment merge(
        List<org.jitsi.webrtcvadwrapper.audio.ByteSignedPcmAudioSegment> segments)
    {
        int totalLength = 0;
        ...
        int marker = 0;
        for(org.jitsi.webrtcvadwrapper.audio.ByteSignedPcmAudioSegment segment : segments)
        {
        ...
        return new org.jitsi.webrtcvadwrapper.audio.ByteSignedPcmAudioSegment(merged);
    }
    ...
    /**
     * Construct a {@link org.jitsi.webrtcvadwrapper.audio.ByteSignedPcmAudioSegment}.
     *
